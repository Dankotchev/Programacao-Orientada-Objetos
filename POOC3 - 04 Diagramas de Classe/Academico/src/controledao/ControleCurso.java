...
import modelo.Curso;
import controledao.exceptions.NotExistException;

/**
 * Classe responsável pelo acesso aos dados dos cursos armazenado no banco de
 * dados
 *
 * @author Aluno
 */
public class ControleCurso {
    ...
    public void inserir(Curso c) throws SQLException {
        ...
        String comandoSQL = "insert into curso (sigla, nome, coordenador) values (?, ?, ?)";
